...
features.columns = ['Country', 'DQ_Age', 'DQ_Education', 'DQ_Employment   ', 'DQ_Marital status', 'DQ_Residence', 'Q_>=1 reason', 'Q_argues', 'Q_burns food', 'Q_goes out w/o telling', 'Q_neglects children', 'Q_refuses sex']
