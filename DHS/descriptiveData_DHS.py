...
print(data)
raw_data = data[['Country', 'Demographics Question', 'Demographics Response', 'Question', 'Survey Year','Value']]
...
features = pd.get_dummies(raw_data[['Country', 'Demographics Question', 'Demographics Response', 'Question', 'Survey Year','Value']])
